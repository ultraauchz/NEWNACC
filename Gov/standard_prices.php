...
-->
					...
					<div class="page-header">
						<h1> <i class="menu-icon fa fa-list"></i> ราคากลาง <i class="ace-icon fa fa-angle-right"></i> ข้อมูลราคากลาง 
						    <?php if(@$action!=''):?>
						...
						<div class="col-xs-12">
                            ...
                            switch(@$_GET['mode']) {
                                case 'result' :
                                    ...
                                    break;
                                case 'edit' :
                                    require_once 'modules/' . $current_page . '/edit.php';
                                    break;
                                case 'new' :
