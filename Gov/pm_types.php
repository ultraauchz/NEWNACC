				...
				<div class="page-content">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">
								ข้อมูลประเภทการจัดซื้อจัดจ้างหลัก
							</li>
						</ul><!-- /.breadcrumb -->
					</div>
					<div class="space space-4"></div>
					<div class="page-header">
						<h1> ข้อมูลประเภทการจัดซื้อจัดจ้างหลัก
						    <?php if(@$action!=''):?> 
						...
						<div class="col-xs-12">
                            ...
                            switch(@$_GET['mode']) {
                            	case 'view' :
                                    ...
                                    break;
                                case 'edit' :
                                    require_once 'modules/'.$current_page.'/main_form.php';
                                    break;
                                case 'new' :
                                    require_once 'modules/'.$current_page.'/main_form.php';
                                    break;
                                default :
                                    require_once 'modules/'.$current_page.'/main_index.php';
                                    break;
                            }
							?>
							<!-- PAGE CONTENT ENDS -->
