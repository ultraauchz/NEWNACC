<form class="form-horizontal" role="form" enctype="multipart/form-data" action="plans">
	<div class="form-group">
		<label class="col-sm-3 control-label no-padding-right">รหัสหน่วยงาน</label>
		<div class="col-sm-5">
	...
	<div class="form-group">
		...
		<div class="col-sm-3">
			<select id="min_code" name="min_code" class="form-control ">
				...
				<option value="5" selected="selected">กระทรวงการพัฒนาสังคมและความมั่นคงของมนุษย์</option>
	...
	<div class="form-group">
		...
		<div class="col-sm-3">
			<select id="min_code" name="min_code" class="form-control ">
				<option value="">--กรุณาระบุ--</option>
				<option value="1" selected="selected">สำนักงานปลัดกระทรวง</option>
			</select>
		</div>
	</div>
	<div class="form-group">
		<label class="col-sm-3 control-label no-padding-right">ชื่อหน่วยงาน<span class="red">*</span></label>
		<div class="col-sm-3">
			<input type="text" class="form-control" value="กองต่อต้านการค้ามนุษย์">
		</div>
	</div>
	<hr>
	<div class="form-group">
