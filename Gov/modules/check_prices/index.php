	...
	<table class="table table-striped table-bordered table-hover">
		...
		<tbody>
			...
			<tr role="row" class="odd">
				...
				<td>ซื้อโครงการมาตรการสำคัญเร่งด่วนเพื่อช่วยเหลือเกษตรการและคนยากจนในการเสริมความเข้มแข็งอย่างยั่งยืน กิจกรรมปลูกมะนาวในวงบ่อซีเมนต์ หมู่ที่ 1,5,6 ตำบลโพสังโฆ โดยวิธีตกลงราคา (เลขที่โครงการ : 59036279422)</td>
				<td>การจัดซื้อจัดจ้างที่มิใช่งานก่อสร้าง</td>
				<td class="right">40,800,000</td>
				<td class="right">40,800,000</td>
				<td>01/01/2559</td>
				<td><span class="label label-sm label-danger">ตรวจสอบแล้ว ไม่ถูกต้อง</span></td>
				<td>
			...
			<tr role="row" class="event">
				...
				<td>ซื้อโต๊ะ เก้าอี้สำนักงาน ชุดโต๊ะ เก้าอี้ ชุดโต๊ะหมู่บูชา และเครื่องเสียงห้องประชุมกรมสนับสนุนบริการสุขภาพ จำนวน 1 ชุด โดยวิธีตกลงราคา (เลขที่โครงการ : 59036277592) </td>
				<td>การจัดซื้อจัดจ้างที่มิใช่งานก่อสร้าง</td>
				<td class="right"> 4,800,000</td>
				<td class="right"> 4,700,000</td>
				<td>31/03/2559</td>
				<td class=""><span class="label label-sm label-warning">ระหว่างการตรวจสอบ</span></td>
				<td>
					<a class="blue" href="<?php echo $current_page; ?>?mode=view"> <i class="ace-icon fa fa-search-plus bigger-130"></i> </a>
					<a class="green" href="<?php echo $current_page; ?>?mode=edit"> <i class="ace-icon fa fa-pencil bigger-130"></i> </a>
					<a class="red btn_delete" href="<?php echo $current_page; ?>?mode=delete"> <i class="ace-icon fa fa-trash-o bigger-130"></i> </a>
			...
			<tr role="row" class="odd">
				...
				<td class="right">40,800,000</td>
				<td>17/06/2558</td>
				<td class=""><span class="label label-sm label-success">ตรวจสอบแล้ว ถูกต้อง</span></td>
				<td nowrap="nowrap">
					<a class="blue" href="<?php echo $current_page; ?>?mode=view"> <i class="ace-icon fa fa-search-plus bigger-130"></i> </a>
					<a class="green" href="<?php echo $current_page; ?>?mode=edit"> <i class="ace-icon fa fa-pencil bigger-130"></i> </a>
					<a class="red btn_delete" href="<?php echo $current_page; ?>?mode=delete"> <i class="ace-icon fa fa-trash-o bigger-130"></i> </a>
			...
			<tr role="row" class="event">
				...
				<td class="right">351,316.20</td>
				<td>21/03/2559</td>
				<td class=""><span class="label label-sm label">ระหว่างดำเนินการ</span></td>
				<td>
					<a class="blue" href="<?php echo $current_page; ?>?mode=view"> <i class="ace-icon fa fa-search-plus bigger-130"></i> </a>
					<a class="green" href="<?php echo $current_page; ?>?mode=edit"> <i class="ace-icon fa fa-pencil bigger-130"></i> </a>
					<a class="red btn_delete" href="<?php echo $current_page; ?>?mode=delete"> <i class="ace-icon fa fa-trash-o bigger-130"></i> </a>
			...
			<tr role="row" class="event">
				...
				<td class="">โรงพยาบาลสุวรรณภูมิ</td>
				<td>สอบราคาซื้อเครื่องดมยาสลบชนิด 3 แก๊ส พร้อมเครื่องช่วยหายใจและวิเคราะห์ระหว่างดมยา</td>
				<td>การจัดซื้อจัดจ้างที่มิใช่งานก่อสร้าง</td>
				<td class="right">1,700,000.00</td>
				<td class="right">1,700,000.00</td>
				<td>16/03/2559</td>
				<td class=""><span class="label label-sm label-success">ตรวจสอบแล้ว ถูกต้อง</span></td>
				<td>
