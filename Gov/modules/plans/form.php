<form class="form-horizontal" role="form" enctype="multipart/form-data" action="plans">
	<div class="form-group">
		<label class="col-sm-3 control-label no-padding-right">เลขคุมสัญญาโครงการ</label>
		<div class="col-sm-5">
			<input type="text" name="project_id" class="form-control" readonly="true" value="5903002000001">
		</div>
	</div>
	<div class="form-group">
