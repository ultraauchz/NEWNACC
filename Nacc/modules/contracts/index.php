	...
	<table class="table table-striped table-bordered table-hover">
		<thead>
			<tr role="row">
				...
				<th>เลขคุมสัญญา</th>
				<th >คู่สัญญา</th>
				<th class="sorting_disabled" tabindex="0" aria-controls="dynamic-table" rowspan="1" colspan="1" >ชื่อสัญญา</th>
				<th class="sorting_disabled" tabindex="0" aria-controls="dynamic-table" rowspan="1" colspan="1" >มูลค่าสัญญา</th>
				<th >หน่วยงาน</th>
				<th class="sorting_disabled " tabindex="0" aria-controls="dynamic-table" rowspan="1">ระยะเวลาสัญญา</th>
				<th class="sorting_disabled " tabindex="0" aria-controls="dynamic-table" rowspan="1">สิ้นสุดภาระผูกพันวันที่</th>
