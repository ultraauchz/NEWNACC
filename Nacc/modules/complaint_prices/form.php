...
<ul class="nav nav-tabs" id="recent-tab">
	<li class="active">
		<a data-toggle="tab" href="#pageone" aria-expanded="true">ข้อมูลราคากลาง</a>
	</li>
	<li class="">
		<a data-toggle="tab" href="#pagetwo" aria-expanded="false">การตรวจสอบราคากลาง</a>
	</li>
	<li class="">
		<a data-toggle="tab" href="#pagethree" aria-expanded="false">ข้อมูลการร้องเรียนความผิดปกติของราคากลาง หรือ TOR</a>
	</li>
</ul>
...
<form class="form-horizontal" role="form" enctype="multipart/form-data" action="<?php echo $current_page;?>">
	<div class="dv-main-standard">
		...
		<div class="form-group">
			<label class="col-sm-3 control-label no-padding-right">หน่วยงาน<span class="red">*</span></label>
			<div class="col-xs-12 col-sm-9 col-lg-5">
				<select name="sec_code" class="form-control">
					<option value="">--กรุณาระบุ--</option>
...
<div id="pagetwo" class="tab-pane row">
	...
	<table class="table table-bordered">
		...
		<tr>
			<td><span class="label label-sm label-success">ตรวจสอบแล้ว ถูกต้อง</span></td>
			<td>เอกสารถูกต้อง</td>
			<td>02/04/2559 15:06:30</td>
			<td>นางสาวสดใส สดใส</td>
			<td> ศูนย์กำกับดูแลการจัดซื้อจัดจ้างภาครัฐ
			<br>
			สำนักงานคณะกรรมการป้องกันและปราบปรามการทุจริตแห่งชาติ </td>
		</tr>
		<tr>
			<td><span class="label label-blue">รอการตรวจสอบ</span></td>
			<td></td>
			<td>02/04/2559 10:06:30</td>
			<td>นายทดสอบ ทดสอบ</td>
			<td> ศูนย์เทคโนโลยีสารสนเทศและการสื่อสาร
			<br>
			สำนักงานปลัดกระทรวงการพัฒนาสังคมและความมั่นคงของมนุษย์
			<br>
			กระทรวงการพัฒนาสังคมและความมั่นคงของมนุษย์ </td>
		</tr>
		<tr>
			<td><span class="label label-danger">ตรวจสอบแล้ว ไม่ถูกต้อง</span></td>
			<td>รายการเอกสารที่ใช้ในการเผยแพร่ราคากลางไม่ครบถ้วน</td>
...
<div id="pagethree" class="tab-pane row">
	...
	<table class="table table-bordered">
			...
			<tbody><tr>
				<td>05/01/2559</td>
				<td>บริษัท ตรวจสอบ จำกัด</td>
				<td>02-849-1236</td>
				<td>test@test.com</td>
				<td>
					รายที่ต้องการจัดซื้อมีการราคากลางถูกกว่าที่ขายตามท้องตลาด
				</td>
				<td>
					<input type="button" value="ชี้แจงการร้องเรียน" class="btn btn-sm btn-primary">
					<input type="button" value="ลบรายการ" class="btn btn-sm btn-danger">
				</td>
			</tr>
		</tbody>
	</table>
  ...
  <tbody>
	<tr>
		<th class="right">วันที่ร้องเรียน</th>
		<td>05/01/2559</td>
	</tr>
  <tr>
...
<table class="table table-bordered ">
  <tbody>
  <tr>
		<th width="200">วันที่ตอบข้อร้องเรียน</th>
		<th width="200">ผู้ตอบข้อร้องเรียน</th>
    <th >รายละเอียดการตอบข้อร้องเรียน</th>
  </tr>
	<tr>
		<td>06/05/2559 13.05</td>
		<td>
			นาย ทดสอบ  ทดสอบ
		</td>
		<td>..............</td>
...
<table class="table table-bordered ">
  <tbody>
  <tr>
    <th style="width:220px" class="right">ตอบข้อร้องเรียน</th>
