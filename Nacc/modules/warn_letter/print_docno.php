...
<?php if(@$_GET):
?>
<a href="warn_letter_preview_copy" target="_blank" class="btn btn-primary"><i class="fa fa-print"></i>พิมพ์สำเนาคู่ฉบับ</a>
<a href="warn_letter_table_print" target="_blank" class="btn btn-primary"><i class="fa fa-print"></i>พิมพ์ตารางรายชื่อแนบ</a>
