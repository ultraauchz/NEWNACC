			...
			<div class="widget-box">
				...
				<div class="widget-body">
					<div class="widget-main">
						<div class="row">
							<div class="col-sm-2">
								<label for="search">กลุ่มผู้ใช้</label>
						...
						<div class="row">
							<div class="col-sm-3">
								<label for="search">ชือผู้ใช้</label>
								<input type="text" name="search" value="" placeholder="ชือผู้ใช้" class="form-control">
							</div>
						</div>
						<div class="space space-8"></div>
						<div class="row">
...
<div class="row">
	<div class="col-sm-12">
		...
		<button name="submit" class="btn btn-primary">
			<i class="fa fa-plus-square fa-plus-square-o"></i> เพิ่มข้อมูลผู้ใช้
		</button> </a>
	</div>
</div>
<div class="space space-8"></div>
	...
	<table id="dynamic-table" class="table table-striped table-bordered table-hover">
		...
		<tbody>
			<tr role="row" class="odd">
				...
				<td>เจ้าหน้าที่หน่วยงานภาครัฐ</td>
				<td>
