<form class="form-horizontal" role="form" enctype="multipart/form-data" action="plans">
	<div class="form-group">
		<label class="col-sm-3 control-label no-padding-right">ประเภทการจัดซื้อจัดจ้างหลัก<span class="red">*</span></label>
		<div class="col-sm-3">
	...
	<div class="form-group">
		<label class="col-sm-3 control-label no-padding-right">ประเภทการจัดซื้อจัดจ้างย่อย<span class="red">*</span></label>
		<div class="col-sm-3">
