			...
			<div class="widget-box">
				...
				<div class="widget-body">
					<div class="widget-main">
						...
						<div class="row">
							<div class="col-sm-3">
								<label for="search">ประเภทการจัดซื้อจัดจ้างหลัก</label>
...
<div class="row">
	<div class="col-sm-12">
		...
		<button name="submit" class="btn btn-primary">
			<i class="fa fa-plus-square fa-plus-square-o"></i> เพิ่มข้อมูลประเภทการจัดซื้อจัดจ้างย่อย
		</button> </a>
	</div>
</div>
<div class="space space-8"></div>
	...
	<table id="dynamic-table" class="table table-striped table-bordered table-hover">
		<thead>
			<tr role="row">
				...
				<th>ประเภทการจัดซื้อจัดจ้างหลัก</th>
				<th>ประเภทการจัดซื้อจัดจ้างย่อย</th>
				<th width="100"></th>
			</tr>
		</thead>
		<tbody>
