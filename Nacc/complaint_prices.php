...
<!-- /.breadcrumb
 ...
 -->
					...
					<div class="page-header">
						<h1> <i class="menu-icon fa fa-list"></i> ราคากลาง <i class="ace-icon fa fa-angle-right"></i> ข้อมูลการร้องเรียนความผิดปกติของราคากลาง หรือ TOR
						    <?php if(@$action!=''):?>
